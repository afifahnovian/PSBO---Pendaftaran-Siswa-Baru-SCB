<fieldset>
    <h2 class="fs-title">Upload Berkas</h2>
    <hr>
        ...
        <div class="form-group">
        <label for="sertifikat">Scan / Foto Sertifikat Prestasi</label>
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="validatedCustomFile" name="sertifikat" required>
                <label class="custom-file-label" for="validatedCustomFile">Pilih file ... (.jpg / .png / .pdf) (</label>
                <div class="invalid-feedback">File tidak boleh kosong</div>
            </div>
        </div>
