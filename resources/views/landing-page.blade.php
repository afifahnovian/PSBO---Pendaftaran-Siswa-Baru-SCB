                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto">
                            ...
                            <a class="" href="{{url('/syarat-smp')}}"><img class="img-fluid" style="align:center;" src="assets/img/siswa-smp.png" alt="" /></a>
                        </div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
                            ...
                            <a class="" href="syarat-tahfidz"><img class="img-fluid" src="assets/img/siswa-tahfiz.png" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
