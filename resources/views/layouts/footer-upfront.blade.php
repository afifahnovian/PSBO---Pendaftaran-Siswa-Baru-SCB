        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4-2 mb-5 mb-lg-0 container">
                    ...
                    <a class="btn btn-outline-light btn-social mx-1" href="https://www.cendekiabaznas.sch.id/"><i class="fas fa-fw fa-globe" style ="color:#f8b400;"></i></a>
                    <a class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/edu_baznas"><i class="fab fa-fw fa-twitter" style ="color:#f8b400;"></i></a>
                    <a class="btn btn-outline-light btn-social mx-1" href="humas.scb@gmail.com"><i class="fas fa-envelope-open-text" style ="color:#f8b400;"></i></a>
                    <a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/pendidikanbaznas"><i class="fab fa-fw fa-facebook-f" style ="color:#f8b400;"></i></a>
                    <a class="btn btn-outline-light btn-social mx-1" href="https://www.instagram.com/pendidikanbaznas/"><i class="fab fa-fw fa-instagram" style ="color:#f8b400;"></i></a>
                    </div>
                </div>
